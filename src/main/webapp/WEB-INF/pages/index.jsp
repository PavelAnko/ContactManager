...
<html>
    ...
    <body>
        <div class="container">
           <h3><img height="50" width="55" src="@{/static/logo.png}"/><a href="/">Contacts List</a></h3>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            <li><button type="button" id="delete_group" class="btn btn-default navbar-btn" data-group-id="${groupId}">Delete Group</button></li>
                            <li><button type="button" id="upload_contacts" class="btn btn-default navbar-btn" data-group-id="${groupId}">Upload Contacts</button></li>
                            <li><button type="button" id="save_contacts" class="btn btn-default navbar-btn" data-group-id="${groupId}">Save Contacts</button></li>
                            <li class="dropdown">
